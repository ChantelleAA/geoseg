    ...
    with SafeOutputCapture() as output:
        try:
            ...
            for epoch in range(epochs):
                ...
                # Calculate validation metrics - FIXED: correct method names
                ...
                val_score = {
                    'mIoU': np.nanmean(iou_scores),  # Fixed: correct method and nanmean for handling NaN
                    'F1': np.nanmean(f1_scores),     # Fixed: correct method and nanmean for handling NaN  
                    'OA': oa_score                   # Fixed: correct method name
                }
